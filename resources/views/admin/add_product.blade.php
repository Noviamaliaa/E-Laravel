			...
			<form class="form-horizontal" action="{{ url('save-product') }}" method="post" enctype="multipart/form-data">
				...
				<fieldset>
					...
					<div class="control-group hidden-phone">
						...
						<div class="controls">
							<input type="text" class="input-xlarge" name="product_price" required=""></textarea>
						</div>
					</div>
					...
					<div class="control-group hidden-phone">
						...
						<div class="controls">
							<input type="text" class="input-xlarge" name="product_size" required=""></textarea>
						</div>
					</div> 
					...
					<div class="control-group hidden-phone">
						...
						<div class="controls">
							<input type="text" class="input-xlarge" name="product_color" required=""></textarea>
						</div>
					</div> 
